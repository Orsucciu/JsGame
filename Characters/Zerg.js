/******* Define Zerg units *******/
/******* This file contain all the constructors for the zergs units.*******/
var Zerg={};
...
Zerg.MegaZergling=AttackableUnit.extends({  //ici, un test de création choses
    constructorPlus:function(props){
        this.sound.burrow=new Audio('bgm/Zerg.burrow.wav');
        this.sound.unburrow=new Audio('bgm/Zerg.unburrow.wav');
    },
...
Zerg.Grunt=AttackableUnit.extends({
    constructorPlus:function(props){
        this.sound.burrow=new Audio('bgm/Zerg.burrow.wav');
        this.sound.unburrow=new Audio('bgm/Zerg.unburrow.wav');
        this.direction=3;
